...
| `themeOptions` | Opciones visuales acotadas por tema, incluida la paleta semántica Bootstrap 5. |
| `search` | Búsqueda optativa por nombre, con límites de resultados, recorrido y tiempo. |
| `dragMove` | Movimiento directo optativo mediante arrastre o **Mover a…**. |
...
Continúa con [búsqueda de carpetas y archivos](./search),
[movimiento directo](./moving), [uploads y URLs](./storage) o revisa la
