...
El tema Bootstrap 5 `0.4` presenta el buscador, sus estados y contadores con la misma altura y lenguaje visual de la barra principal. El tema no ejecuta el recorrido: toda la política continúa en el núcleo.
